...
public class BillDao {
    ...
    public static ArrayList<Bill> getAllRecordsByInc(String email,String date)
    {
        ArrayList<Bill> arrayList=new ArrayList<>();
        try{
            ResultSet rs=DbOperations.getData("select * from bill where email='"+email+"' and date like '%"+date+"%'");
            while(rs.next())
            {
                Bill bill=new Bill();
    ...
    public static ArrayList<Bill> getAllRecordsByDesc(String email,String date)
    {
        ArrayList<Bill> arrayList=new ArrayList<>();
        try{
            ResultSet rs=DbOperations.getData("select * from bill where email='"+email+"' and date like '%"+date+"%' order By id DESC");
            while(rs.next())
            {
                Bill bill=new Bill();
                bill.setId(rs.getInt("id"));
